...
<!-- start: sweetalert2 -->
  ...
  function Paginacion(pag) {
	$('#txtPagina').val(pag);
	var url="PaginacionNoticia.php";
	$.ajax({
		type: "POST",
		url: url,
		data: $("#FrmBusquedaNoticia").serialize(), //
...
<link rel="shortcut icon" href="img/logodifblanco.png">
    ...
    <div id='cssmenu'>  
      <ul>
        ...
        <li class='active'><a href='busquedanoticia.php'>Ver Noticia</a></li>
    ...
    <div class="col-md-10" style="width: 100%;">
        <div class="col-md-12 panel">
           <div class="col-md-12 panel-heading">
              <h4 class="Titulos">RESUMEN DE NOTICIA ADMINISTRATIVA</h4>
           </div>
           <div class="col-md-12 panel-body" style="padding-bottom:30px;">
              <div class="col-md-12">
              <form id="FrmBusquedaNoticia" name="FrmBusquedaNoticia" method="post" action="">
